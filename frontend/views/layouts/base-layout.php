...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title>
        <?= Html::encode($this->title) ?> - Perpusnas RI
    </title>
            ...
            <nav class="navbar navbar-static-top">
                <div class="container">
                    <div class="navbar-header">
                        <div class="title">
                            <div class="image"><img
                                    src="<?= Yii::$app->urlManager->createUrl('./uploaded_files/aplikasi/logo_perpusnas_2015.png') ?>"
                                    class="img-logo" height="65" width="70"></div>
                            <div class="text">
                                <h3>
                                ...
                                <div class="clear"></div>
                                <div class="timeddr" style="margin-bottom: 10px">
                                    <!-- <?= Yii::$app->config->get('NamaLokasiPerpustakaan') ?> -->
                                </div>
                                <div class="clear"></div>
                            </div>
        ...
        <footer class="footer main-footer">
            <div class="container">
                ...
                <?= yii::t('app', \Yii::$app->params['year']); ?> <a href="http://inlislite.perpusnas.go.id"
                    target="_blank">
                    <?= yii::t('app', 'Perpustakaan Nasional Republik Indonesia') ?>
                </a>
            </div> <!-- /.container -->
        </footer>
        <?php $this->endBody() ?>
