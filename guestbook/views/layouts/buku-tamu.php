...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title>
        <?= Html::encode($this->title) ?> - Perpustakaan & Galeri Kota Bogor
    </title>
    ...
    <div class="wrapper">
            ...
            <nav class="navbar navbar-static-top">
                <div class="container">
                    <div class="navbar-header">
                        <div class="title">
                            <div class="image"><img
                                    src="<?= Yii::$app->urlManager->createUrl('../uploaded_files/aplikasi/logo-perpuskotabogor.jpg') ?>"
        ...
        <footer class="footer main-footer">
            <div class="container">
                ...
                <p>Perpustakaan & Galeri Kota Bogor</p>
                </a>
            </div> <!-- /.container -->
        </footer>
        <?php $this->endBody() ?>
