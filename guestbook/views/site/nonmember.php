...
Yii::$app->view->params['subTitle'] = '<h3>' . Yii::t('app', 'Selamat Datang') . '<br>' . Yii::t('app', 'Di ') . $location->Name . '</h3><h5 style="background-color: yellow; display: block;">( ' . Yii::t('app', 'Buku Tamu Manual, dikarenakan Server Sedang Offline') . ')</h5>';
    ...
    <div class="col-sm-12" style="padding:0 -15px">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <!-- <li><a href="<?= Yii::$app->getUrlManager()->createUrl('site/member') ?>">
                        <?= Yii::t('app', 'Anggota') ?>
                    </a></li> -->
                <li class="active"><a href="#tab_2" data-toggle="tab">
                        <?= Yii::t('app', 'Pengunjung') ?>
                    </a></li>
                <li><a href="<?= Yii::$app->getUrlManager()->createUrl('site/group') ?>">
                        <?= Yii::t('app', 'Rombongan') ?>
                    </a></li>
            </ul>
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            ...
                            <?php if ($location->IsVisitsDestination == 0) { ?>
                                <div class="row form-group">
                                    <label class="col-sm-3 col-sm-offset-1 control-label">
                                        <?= Yii::t('app', 'Tujuan') ?>
                                    </label>
                            ...
                            <!-- QR GENERATOR FUNGSI START-->
                            <!-- <?php if ($location->IsGenerateVisitorNumber == 1) { ?>
                                <input type="hidden" name="IsGenerateVisitorNumber" id="IsGenerateVisitorNumber"
                                    value="true" />

                                <div id="barcodeNumber"
                                    data-barcode-number="<?= Yii::$app->session->getFlash('barcodeNumber') ?>">
                                </div>
...
<audio id="welcomeAudio" width="320" height="176" hidden="hidden">
    <source src="<?= Yii::$app->urlManager->createUrl("../uploaded_files/settings/audio/") . '/' . $audio['Value'] ?>"
        type="audio/mpeg">
